        ...
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div className="flex  lg:order-2">
            <a href="https://support.expressshopifysupport.com/support/login">
              <button
                type="button"
                className="text-white lg:block hidden bg-[#144645] hover:bg-[#226766] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 text-center mr-3 md:mr-0 "
              >
                Login
              </button>{" "}
            </a>
              ...
              <ul className="flex flex-col  lg:flex-row lg:space-x-8 lg:mt-0 lg:text-sm lg:font-medium">
                ...
                <li>
                  <a className="inline-block" href="">
                    <button
                      type="button"
                      className="text-white mt-3 lg:hidden bg-[#144645] hover:bg-[#226766] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 text-center mr-3 lg:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                      Login
                    </button>
                  </a>
