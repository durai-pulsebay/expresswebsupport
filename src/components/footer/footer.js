  ...
  return (
    <div>
      <footer class="mx-auto py-5 flex items-center flex-col bg-footer-black">
        ...
        <div class="pb-5 flex flex-wrap">
          <div class="my-auto py-3  text-[#fff]">
            <button class="hidden"></button>
            <ul class="flex flex-wrap justify-center text-center items-center py-3">
              <li class="pr-5 py-2">
                <a
                  class="px-3"
          ...
          <div class="flex justify-center py-3">
            <a href="#">
              <img class="pr-3" src="assets/images/facebook.svg" alt="" />
            </a>
            <a href="#">
              <img class="pr-3" src="assets/images/instagram.svg" alt="" />
            </a>
            <a href="#">
              <img class="pr-3" src="assets/images/Linked-in.svg" alt="" />
            </a>
          </div>
        </div>
        <div class="container text-center py-3 text-[#ffffff] border-t border-[#FBF7ED] ">
          <div>
            <p>
              ...
              <span class="font-medium text-[#91D63F]">
