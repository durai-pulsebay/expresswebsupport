      ...
      <section class="bg-sandel-clr">
        ...
        <div className="container ">
          ...
          <p className="text-md pb-5">
            ...
            and your rights and responsibilities when using our services. These
            Terms govern your access to and use of services we provide. <br />
            ...
            to be bound by all of the Terms and all other operating rules,
            policies, and procedures that we may publish from time to time. If
            you don’t agree to these Terms, please don’t use
          </p>
          ...
          <p className="text-md pb-5">
            ...
            to our Services as stated in the Terms, and the Agreement will apply
            to any changes. Please check the applicable Terms every time you use
            our Site so that you understand which Terms apply.
          </p>
          <h3 className="font-medium capitalize text-xl pb-2 text-dark-green">
            1. Who’s Who
          </h3>
          <p className="text-md pb-5">
            ...
            Services you’re accepting the Agreement on behalf of that person or
          ...
          <ul className="pl-5 pb-5">
            ...
            <li className="flex ">
              ...
              <p>
                2.3 to have the legal capacity and you agree to comply with the
                Terms of Use 2.4 that you are not a minor and are over 18 years
                of age
              </p>
            </li>
            <li className="flex ">
              ...
              <p>
                to maintain the accuracy of such information and promptly update
            ...
            <li className="flex ">
              ...
              <p>
                that you will not access the Site through automated or non-human
            ...
            <li className="flex ">
              ...
              <p>
                for us to communicate with you about your account and also share
                more details about what we have to offer (i.e., marketing).
                Don’t worry — if you aren’t interested, you can opt out of the
            ...
            <li className="flex">
              ...
              <p>
                that we may limit your access to our Services until we are able
                to verify your account information, like your email address.
              </p>
            </li>
          </ul>
          <p className="text-md pb-5">
          ...
          <ul className="pb-5 pl-5">
            <li className="flex">
              ...
              <p>
                ...
                following: Malware/Hack Cleanup, Fix PHP Errors, White Screen of
                Death, Dead Links, Update Core site along with Plugins and
                Theme.
              </p>
            </li>
            <li className="flex">
            ...
            <li className="flex">
              ...
              <p>
                ...
                website, configuration of an external hosting environment, data
                entry, content writing, link building and closing SQL injection
                vulnerabilities present in custom code.
              </p>
            </li>
            <li className="flex">
              ...
              <p>
                ...
                task must be submitted as a separate task. If multiple tasks are
                submitted in a single submission we reserve the right to either
                reject the order or reassign each individual task or fix to
                separate orders. You will be charged for each individual website
                fix or task.
              </p>
            </li>
            <li className="flex">
              ...
              <p>
                ...
                details of the website fix or task are provided to us. Whilst we
                endeavour to complete any website fix within 48 hours of
                accepting the order, we offer no guarantee as to how long it
                will take us to complete the website fix. We will dedicate a
                reasonable amount of time required to complete the website fix.
                However, if we are unable to complete a fix within a reasonable
                amount of time we reserve the right to cancel your order and
                fully refund the fee paid for the fix.
              </p>
            </li>
            <li className="flex">
              <p className="pr-5">3.6</p>
              <p>
                Team member: Wherever possible we attempt to appoint a specific
                team member to complete a website fix. However, we work as a
                team and any team member may work on your website fix at any
                given time
              </p>
            </li>
            <li className="flex">
              ...
              <p>
                Incomplete website fix: There will be occasions where it is not
                possible to fix the problem, for example where the website is
                irretrievably broken or where features of your website are
            ...
            <li className="flex">
              ...
              <p>
                ...
                complete any website fix or task. However, it is not possible to
                guarantee any website fix or task will be error free. Where
            ...
            <li className="flex">
              ...
              <p>
                Completion of Fix: We will notify you via email when the task is
                completed. You will have a chance to reply back to us with a
            ...
            <li className="flex">
              ...
              <p>
                3rd Parties: Express Shopify Support is not responsible for any
                work done by third parties on your website, or for any software
                or plugins that are utilised by you. There may be occasions
                where actions by third party suppliers, such as website hosts,
                software and plugin developers, web browsers, email clients,
                domain name registrars or search engines, will affect Express
                Shopify Support’s ability to complete a fix or task. In the
                event of a third party interruption we will not be liable for
                any delay in completing the fix or task. You will not be
                entitled to a refund in the event that we are unable to complete
                a website fix or task as a result of a third party’s action.
              </p>
            </li>
          </ul>
          <h3 className="font-medium capitalize text-xl pb-2 text-dark-green">
          ...
          <ul className="pb-5 pl-5">
            ...
            <li className="flex">
              ...
              <p>
                Any content that is for sale through any of our Services is the
                seller’s sole responsibility, so you must look solely to the
                seller for any damages that result from your purchase or use of
                content.
              </p>
            </li>
            <li className="flex">
          ...
          <ul className="pb-5 pl-5">
            <li className="flex">
              ...
              <p>
                ...
                correct. Where GST is applicable (based on your location and the
                services you order) it shall be detailed on the order steps.
              </p>
            </li>
            <li className="flex">
          ...
          <p className="text-md pb-5">
            ...
            policy below. <br />
            <br />
            We endeavor to complete any website fix to your satisfaction within
            agreed timeframe with our chat agent. It may sometimes take us
            longer than anticipated. In case of a delay, we will advise you of
            an expected completion time and reason for a delay. If we are unable
            to complete a fix within a reasonable amount of time, we reserve the
            right to cancel your order and fully refund the fee fully paid for
            the fix.
            <br />
            ...
            work on it or you are unable to provide the access we need, you will
            only be eligible for a 50% refund.
            <br />
          ...
          <p className="text-md pb-5">
            ...
            arising out of or related to your use of our Services, including but
            not limited to your violation of the Agreement or any agreement with
            a provider of third-party services used in connection with the
            Services, Content that you post, and any e-commerce activities
          ...
          <p className="text-md pb-5">
            ...
            always looking for ways to improve our Services. By sending us your
            comments, ideas and feedback, you consent to our use of them without
            restriction.
          </p>
          <h3 className="font-medium capitalize text-xl pb-2 text-dark-green">
            11. Disclaimer
          ...
          <p className="text-md pb-5">
            ...
            So, if your interactions would be subjected to such laws, you may
            not use this Site. You may not use the Site in a way that would
          ...
          <p className="text-md pb-5">
            ...
            Express Shopify Support and you concerning our Services. If any part
