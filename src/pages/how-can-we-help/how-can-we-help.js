    ...
    <div>
      <section class="bg-sandel-clr">
        ...
        <div class="container mx-auto">
          <div class="flex flex-wrap text-center md:text-left items-center justify-center md:justify-between my-20 ">
            <div class=" lg:w-1/2 md:pr-20 ">
              ...
              <a class="bg-[#91D63F] text-center font-medium text-[#fff] min-w-[100px] py-2 px-5  my-auto rounded">
                Fix my Issue
              </a>
            </div>
        ...
        <section class="container mx-auto bg-[#59ACA7] rounded-lg">
          <div class="py-5">
            <h2 class="text-center p-5 font-semibold text-2xl text-[#ffffff] ">
              How we can help you!
            </h2>
        ...
        <section class="container mx-auto">
          <div>
            <h2 class="py-10 font-semibold text-4xl text-[#144645] ">
              How we deliver{" "}
              <span class="text-[#59ACA7] ">
                great service with
            ...
            <div class=" lg:w-[58%] flex flex-wrap ">
              <div class="m-5  lg:w-[43%]">
                ...
                <p class="text-sm">
                  ...
                  time it takes for us to fix your problem with a secure payment
              ...
              <div class="m-5 lg:w-[43%]">
                ...
                <p class="text-lg">
                  ...
                  in resolving your type of request. If our team needs more
              ...
              <div class="m-5 lg:w-[60%] ">
                ...
                <p class="text-sm">
                  ...
                  depends on the complexity of the project but will typically be
                  done within 48 hours and notified via email.
                </p>
              </div>
            </div>
          </div>
